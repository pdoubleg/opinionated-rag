...
from src.llm.base import LLMFunctionSpec
from src.utils.pydantic_utils import _recursive_purge_dict_key
...
class ToolMessage(ABC, BaseModel):
    ...
    def dict_example(self) -> Dict[str, Any]:
        return self.model_dump_json(exclude={"result", "purpose"})
