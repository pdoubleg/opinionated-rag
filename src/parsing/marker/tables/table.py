from src.parsing.marker.schema.bbox import merge_boxes, box_intersection_pct, rescale_bbox
from src.parsing.marker.schema.block import Line, Span, Block
from src.parsing.marker.schema.page import Page
from tabulate import tabulate
from typing import List

from src.parsing.marker.settings import settings
from src.parsing.marker.tables.cells import assign_cells_to_columns
from src.parsing.marker.tables.utils import sort_table_blocks, replace_dots, replace_newlines
