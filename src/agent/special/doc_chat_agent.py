...
from src.agent.batch import run_batch_tasks
from src.agent.chat_agent import ChatAgent, ChatAgentConfig
from src.agent.chat_document import ChatDocMetaData, ChatDocument
from src.agent.special.relevance_extractor_agent import (
    RelevanceExtractorAgent,
    RelevanceExtractorAgentConfig,
)
from src.agent.task import Task
from src.embedding_models.base import EmbeddingModelsConfig
from src.embedding_models.models import OpenAIEmbeddingsConfig
from src.embedding_models.models import SentenceTransformerEmbeddingsConfig
from src.llm.base import StreamingIfAllowed
from src.llm.openai_gpt import OpenAIChatModel, OpenAIGPTConfig
from src.types import Document, Entity
from src.parsing.parser import Parser, ParsingConfig, PdfParsingConfig, Splitter
from src.parsing.repo_loader import RepoLoader
from src.parsing.search import (
    find_closest_matches_with_bm25,
    find_fuzzy_matches_in_docs,
    preprocess_text,
)
from src.parsing.table_loader import describe_dataframe
from src.parsing.url_loader import URLLoader
from src.parsing.urls import get_list_from_user, get_urls_and_paths
from src.parsing.utils import batched
from src.prompts.prompts_config import PromptsConfig
from src.prompts.templates import SUMMARY_ANSWER_PROMPT_GPT4
from src.utils.configuration import settings
from src.utils.constants import NO_ANSWER
from src.utils.output import show_if_debug
from src.utils.pydantic_utils import dataframe_to_documents, extract_fields
from src.db.base import VectorStore, VectorStoreConfig
from src.db.lancedb import LanceDBConfig
...
class DocChatAgentConfig(ChatAgentConfig):
    ...
    hf_embed_config: EmbeddingModelsConfig = SentenceTransformerEmbeddingsConfig(
        model_type="sentence-transformer",
        model_name="BAAI/bge-large-en-v1.5",
    )

    oai_embed_config: EmbeddingModelsConfig = OpenAIEmbeddingsConfig(
        model_type="openai",
