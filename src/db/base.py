...
from src.embedding_models.base import EmbeddingModel, EmbeddingModelsConfig
from src.embedding_models.models import OpenAIEmbeddingsConfig
from src.types import Document
from src.utils.algorithms import components, topological_sort
from src.utils.configuration import settings
from src.utils.output import print_long_text
from src.utils.output import stringify
...
class VectorStore(ABC):
    ...
    def create(config: VectorStoreConfig) -> Optional["VectorStore"]:
        from src.db.chromadb import ChromaDB, ChromaDBConfig
        from src.db.lancedb import LanceDB, LanceDBConfig
        from src.db.qdrantdb import QdrantDB, QdrantDBConfig
