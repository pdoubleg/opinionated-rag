...
class Settings(BaseSettings):
    ...
    BBOX_INTERSECTION_THRESH: float = 0.75 # How much the layout and pdf bboxes need to overlap to be the same
    ...
    EDITOR_CUTOFF_THRESH: float = 0.95 # Ignore predictions below this probability
